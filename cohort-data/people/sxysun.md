...
A member of the Teleport Router crew (cross-network routing), alongside steward Andrew Miller and sevenfloor. GitHub sxysun; builds in the TEE-attestation space (fisherman, is-this-real-tea). Site: teleport.best.
